export const typographyTokens = {
  ...
  body: { fontSize: "1rem", lineHeight: "1.55", fontWeight: 400 },
  small: { fontSize: "0.875rem", lineHeight: "1.45", fontWeight: 400 },
  caption: { fontSize: "0.75rem", lineHeight: "1.4", fontWeight: 600 },
  code: { fontSize: "0.875rem", lineHeight: "1.5", fontWeight: 500 }
} as const;
